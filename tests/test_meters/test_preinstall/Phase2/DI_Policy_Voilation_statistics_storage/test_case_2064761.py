...
Test Case Link : https://dev.azure.com/itron/SoftwareProducts/_workitems/edit/2064761
===================================================================================================
Test Case      : 2064761
Description    : Verify Agent requested Exceeded Upstream dailyDataWarningLimit and the Policy Violation is recorded in  PolicyViolationStatistics table
...
===================================================================================================
Step 1 - 
Verify Agent requested Exceeded Upstream dailyDataWarningLimit and the Policy Violation is recorded
in PolicyViolationStatistics

Step 2 - 
AgentId     FeatureID     ConstraintID 6    ViolationParameter  \"Over Daily Data Warning Limit: [%]
Bytes\"    ViolationCount
...
import time
# AUTOGENERATED Test Case 2064761

# @pytest.mark.skip(reason="TODO: unimplemented test case")
@pytest.mark.regress_nightly
# @pytest.mark.regress_smoke
@pytest.mark.suite_id("2060761")
@pytest.mark.test_case("2064761")
def test_case(preinstalled_meter, logger,workdir):
    logger.trace("Executing Test Case 2064761 - Verify Agent requested Exceeded Upstream dailyDataWarningLimit and the Policy Violation is recorded in  PolicyViolationStatistics table")
    ...
    old_word = '<Upstream dailyAlarmLimit="100" dailyDataLimit="1000"/>' 
    new_word = '<Upstream dailyAlarmLimit="100" dailyDataWarningLimit="3" dailyDataLimit="1000"/>'
    ...
    try:
        ...
        if initial_max_timestap[0] != '':
            query = f'select ViolationParameter from PolicyViolationStatistics where agentid = {agent_id}  and timestamp > {initial_max_timestap[0]} and ConstraintID = 6 order by timestamp desc limit 1'
        else:
            query = f'select ViolationParameter from PolicyViolationStatistics where agentid = {agent_id} and ConstraintID = 6 order by timestamp desc limit 1'
        ...
        while time_out>time.time():
            ...
            value = ViolationParameter and int(ViolationParameter[0]) == 3
            if value :
                break 
            else:
                c+=1
        ...
        logger.trace('Step 2')
        assert value,"There is no violation register in policyviolationstatistics with constraint id 6"
