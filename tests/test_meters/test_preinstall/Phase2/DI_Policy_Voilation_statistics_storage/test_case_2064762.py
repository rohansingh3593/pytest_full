...
Test Case Link : https://dev.azure.com/itron/SoftwareProducts/_workitems/edit/2064762
===================================================================================================
Test Case      : 2064762
Description    : Verify Agent requested Exceeded Upstream dailyDataWarningLimit and the Policy Violation is recorded in PolicyViolationStatistics  
...
# AUTOGENERATED Test Case 2064762

# @pytest.mark.skip(reason="TODO: unimplemented test case")
@pytest.mark.regress_nightly
#@pytest.mark.regress_smoke
@pytest.mark.suite_id("2060761")
@pytest.mark.test_case("2064762")
def test_case(preinstalled_meter, logger, workdir):
    logger.trace("Executing Test Case 2064762 - Verify Agent requested Exceeded Upstream dailyDataWarningLimit and the Policy Violation is recorded in PolicyViolationStatistics  ")
    ...
    new_word = '<Upstream dailyAlarmLimit="100" dailyDataWarningLimit="10" dailyDataLimit="1000"/>'
